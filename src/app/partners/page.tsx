    ...
    return (
        <>
            ...
            <main className="pt-20">
                ...
                {/* Filters */}
                <div className="sticky top-20 z-30 bg-white border-b py-4">
                    <div className="container-wide flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <select
                                ...
                                className="border rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-accent focus:outline-none"
                            >
                            ...
                            {bankPartners
                                ...
                                .map((partner) => (
                                    <Card
                                        key={partner.id}
                                        hover
                                        className="cursor-pointer group ring-1 ring-gray-100 hover:ring-primary/20 transition-all"
                                        ...
                                        <CardContent className="p-6">
                                            ...
                                            <div className="mt-6 flex items-center justify-between text-sm">
                                                ...
                                                <div className="text-right">
                                                    <p className="text-gray-500 mb-1">Max Tenure</p>
                                                    <p className="font-semibold">{partner.maxTenure} Months</p>
                                                </div>
                                            </div>

                                            <div className="mt-6 pt-4 border-t flex justify-between items-center text-sm font-medium text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                                                View Details
                    ...
                    {activePartner && activeDetails && (
                        <div className="space-y-6">
                            <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl">
                                ...
                                <div>
                                    <p className="text-sm text-gray-500">Starting Interest Rate</p>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="p-4 border rounded-lg">
                                    ...
                                    <p className="font-medium">{activeDetails.processingFee}</p>
                                </div>
                                <div className="p-4 border rounded-lg">
                            ...
                            <div className="pt-4 flex gap-3">
                                ...
                                <Button variant="outline" className="flex-1" rightIcon={<ExternalLink className="w-4 h-4" />}>
                                    Visit Website
                                </Button>
                            </div>
                        </div>
