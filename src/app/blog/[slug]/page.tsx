            ...
            <main className="pt-24 min-h-screen bg-surface">
                <Section background="surface" size="md">
                    <div className="max-w-3xl mx-auto">
                        ...
                        <Link 
                            href="/blog" 
                            className="inline-flex items-center gap-2 text-sm text-white/50 hover:text-accent mb-8 transition-colors group"
                        >
                        ...
                        <header className="mb-10">
                            ...
                            <div className="flex items-center justify-between py-6 border-y border-white/10">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        <p className="text-sm font-bold text-white">KBD Editorial</p>
                                        ...
                                        {relatedPosts.map((related) => {
                                            ...
                                            return (
                                                <Link 
                                                    ...
                                                    className="group p-5 rounded-2xl bg-white/5 border border-white/10 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300"
                                                >
                                                    <div className="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center text-white/30 group-hover:bg-accent/10 group-hover:text-accent transition-colors mb-4">
                                                        <RelatedIcon className="w-5 h-5" />
                                                    </div>
                                                    <span className="text-xs font-medium text-accent/70 mb-2 block">
                                                        {related.category}
                                                    </span>
                                                    <h3 className="font-bold text-white group-hover:text-accent transition-colors mb-2 line-clamp-2 text-sm">
                                                        {related.title}
                                                    </h3>
                                                    <p className="text-xs text-white/50 line-clamp-2 mb-0">
                                                        {related.excerpt}
                                                    </p>
                                                </Link>
                                            );
