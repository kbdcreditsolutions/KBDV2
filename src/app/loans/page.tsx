...
import { loanTypes, bankPartners } from '@/lib/constants';
import { formatCurrency, formatPercentage } from '@/lib/utils';
import { ArrowRight, Filter, Clock, Percent, Building2 } from 'lucide-react';
                ...
                <Section background="surface" size="md">
                    <div className="flex items-center justify-between mb-8">
                        <p className="text-gray-600">
                            Showing <span className="font-semibold text-gray-900">{loanOffers.length}</span> loan offers
                        </p>
